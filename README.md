...
- Neightboring image here means pixels from the preceding frame(s), and proceeding frame(s). These pixels are then "mixed" together, to produce a kind of dreamy look to the video sequence.
